...
# Pull secrets safely from Koyeb environment variables
BOT_TOKEN = os.environ.get("BOT_TOKEN")
SOL_WALLET = os.environ.get("SOL_WALLET", "YOUR_SOL_WALLET_ADDRESS_HERE")
MINI_APP_URL = os.environ.get("MINI_APP_URL", "https://your-bonga-zen.netlify.app")
...
def start_zen(message):
    ...
    # 20-second inhale, 20-second hold sequence with colorful blocks
    phases = [
